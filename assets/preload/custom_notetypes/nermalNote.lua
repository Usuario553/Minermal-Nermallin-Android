function onCreate()
    ...
    --makes the sprite
    makeLuaSprite('nerm1', 'nermal jumpscare', -50, -40)
    scaleObject('nerm1', 1, 1)
    setObjectCamera('nerm1', 'other')

    makeLuaSprite('nerm2', 'nermal jumpscare', -50, 485)
    scaleObject('nerm2', 1, 1 * -1) --same image just flipped upside down bc of y value * -1
